...
#     path = '/media/miao/data/Dataset/MIMIC-CXR/mimic-cxr-reports/files/p10/p10103318/s57408307.txt'
#     with open(path, encoding="utf-8") as f:
#         full_report_text = f.read()
#     sections, section_names, section_idx = section_text(full_report_text)
#     print()
